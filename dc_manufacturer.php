...
<table class="table table-striped table-json" id="table" data-json-file="dc_manufacturer_list.json">
    <thead>
        <tr>
            <th width="5%" data-json-column="manufacturer_id" data-json-sort="asc"></th>
            <th width="20%" data-json-column="name"></th>
        </tr>
    </thead>
    <tbody></tbody>
</table>
